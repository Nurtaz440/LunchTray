...
public abstract class FragmentAccompanimentMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected AccompanimentMenuFragment mAccompainmentMenu;
  ...
  public abstract void setAccompainmentMenu(@Nullable AccompanimentMenuFragment accompainmentMenu);

  @Nullable
  public AccompanimentMenuFragment getAccompainmentMenu() {
    return mAccompainmentMenu;
  }
