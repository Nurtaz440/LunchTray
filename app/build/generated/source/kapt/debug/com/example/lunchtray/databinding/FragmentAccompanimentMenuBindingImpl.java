...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accompainmentMenu == variableId) {
            setAccompainmentMenu((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setAccompainmentMenu(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment AccompainmentMenu) {
        this.mAccompainmentMenu = AccompainmentMenu;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.accompainmentMenu);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.AccompanimentMenuFragment accompainmentMenu = mAccompainmentMenu;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 5: {
                ...
                // accompainmentMenu != null
                boolean accompainmentMenuJavaLangObjectNull = false;
                // accompainmentMenu
                com.example.lunchtray.ui.order.AccompanimentMenuFragment accompainmentMenu = mAccompainmentMenu;



                accompainmentMenuJavaLangObjectNull = (accompainmentMenu) != (null);
                if (accompainmentMenuJavaLangObjectNull) {


                    accompainmentMenu.goToNextScreen();
                }
                break;
            }
            case 3: {
