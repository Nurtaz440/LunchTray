...
public class FragmentStartOrderBindingImpl extends FragmentStartOrderBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.startOrder == variableId) {
            setStartOrder((com.example.lunchtray.ui.order.StartOrderFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setStartOrder(@Nullable com.example.lunchtray.ui.order.StartOrderFragment StartOrder) {
        this.mStartOrder = StartOrder;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
        notifyPropertyChanged(BR.startOrder);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.StartOrderFragment startOrder = mStartOrder;
        // batch finished
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        // startOrder != null
        boolean startOrderJavaLangObjectNull = false;
        // startOrder
        com.example.lunchtray.ui.order.StartOrderFragment startOrder = mStartOrder;



        startOrderJavaLangObjectNull = (startOrder) != (null);
        if (startOrderJavaLangObjectNull) {


            startOrder.startEntireMenu();
        }
    }
    // dirty flag
    private  long mDirtyFlags = 0xffffffffffffffffL;
    /* flag mapping
        flag 0 (0x1L): startOrder
        flag 1 (0x2L): null
    flag mapping end*/
    //end
}