...
class OrderViewModel : ViewModel() {
    ...
    val entree: LiveData<MenuItem?>
    get()= _entree

    // Side for the order
    private val _side = MutableLiveData<MenuItem?>()
    val side: LiveData<MenuItem?>
    get()= _side

    // Accompaniment for the order.
    private val _accompaniment = MutableLiveData<MenuItem?>()
    val accompaniment: LiveData<MenuItem?>
    get()= _accompaniment
...
//            _entree.value!!.price =menuItems[entree]!!.price
//
//        }
...
//        if (_side.value != null){
//            _side.value!!.price =menuItems[side]!!.price
//
//        }
        ...
        previousSidePrice = _subtotal.value!!+previousEntreePrice
...
//            _accompaniment.value!!.price =menuItems[accompaniment]!!.price
//
//        }
        ...
        //  accompaniment.
//        if (_accompaniment.value != null){
//            _accompaniment.value!!.price = menuItems[accompaniment]!!.price - _subtotal.value!!
//        }
        ...
        previousAccompanimentPrice = menuItems[accompaniment]!!.price + previousSidePrice
